...
import grpcAdminClient from '@/transport/grpc/auth-user-service/AdminServices'
import grpcUserClient from '@/transport/grpc/auth-user-service/UserServices'
...
import { ChangeEmailRequest, ChangePasswordRequest, DeleteAccountRequest, ResendOtpRequest, UpdateProfileRequest, VerifyNewEmailRequest } from "@akashcapro/codex-shared-utils";
...
export const profileController = {
  ...
  profile : async (req: Request, res: Response, next : NextFunction) => {
    try {
      ...
      const grpcResponse = await grpcAdminClient.profile({
  ...
  update : async (req : Request, res : Response, next : NextFunction) => {
    try {
        ...
        const result = await grpcUserClient.updateProfile(dto);
  ...
  changePass : async (req : Request, res : Response, next : NextFunction) => {
    try {
        ...
        await grpcUserClient.changePassword(dto);
  ...
  changeEmail : async (req : Request, res : Response, next : NextFunction) => {
    try {
        ...
        await grpcUserClient.changeEmail(dto);
  ...
  resendOtp : async (req : Request, res : Response, next : NextFunction) => {
    try {
        ...
        await grpcUserClient.resendOtp(dto);
  ...
  verifyOtp : async (req : Request, res : Response, next : NextFunction) => {
    try {
        ...
        await grpcUserClient.verifyNewEmail(dto);
  ...
  deleteAccount : async (req : Request, res : Response, next : NextFunction) => {
    try {
      ...
      await grpcUserClient.deleteAccount(dto);
